...
function buildChatCommands(): ChatCommandDefinition[] {
  const commands: ChatCommandDefinition[] = [
    ...
    defineChatCommand({
      key: "allowlist",
      description: "Управление списком доступа.",
      textAlias: "/allowlist",
      acceptsArgs: true,
      scope: "text",
      category: "management",
    ...
    defineChatCommand({
      key: "approve",
      nativeName: "approve",
      description: "Одобрить или отклонить запросы на выполнение.",
      textAlias: "/approve",
      acceptsArgs: true,
      category: "management",
    }),
    ...
    defineChatCommand({
      key: "btw",
      nativeName: "btw",
      description: "Задать вопрос без влияния на контекст сессии.",
      textAlias: "/btw",
      acceptsArgs: true,
      category: "tools",
    }),
    defineChatCommand({
      ...
      description: "Экспорт сессии в HTML файл.",
    ...
    defineChatCommand({
      key: "tts",
      nativeName: "tts",
      description: "Управление озвучкой (TTS).",
      textAlias: "/tts",
      category: "media",
      args: [
        {
    ...
    defineChatCommand({
      key: "session",
      nativeName: "session",
      description: "Настройки сессии (например /session idle).",
      textAlias: "/session",
      category: "session",
      args: [
        {
    ...
    defineChatCommand({
      ...
      description: "Управление субагентами сессии.",
      textAlias: "/subagents",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "acp",
      nativeName: "acp",
      description: "Управление ACP сессиями.",
      textAlias: "/acp",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "focus",
      nativeName: "focus",
      description: "Привязать тред/топик к сессии.",
      textAlias: "/focus",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "unfocus",
      nativeName: "unfocus",
      description: "Отвязать текущий тред/топик.",
      textAlias: "/unfocus",
      category: "management",
    }),
    defineChatCommand({
      key: "agents",
      nativeName: "agents",
      description: "Список агентов сессии.",
      textAlias: "/agents",
      category: "management",
    }),
    defineChatCommand({
      key: "kill",
      nativeName: "kill",
      description: "Остановить субагента.",
      textAlias: "/kill",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "steer",
      nativeName: "steer",
      description: "Направить субагента.",
      textAlias: "/steer",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "config",
      nativeName: "config",
      description: "Показать или изменить настройки.",
      textAlias: "/config",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "debug",
      nativeName: "debug",
      description: "Отладочные настройки.",
      textAlias: "/debug",
      category: "management",
      args: [
        {
    ...
    defineChatCommand({
      key: "usage",
      nativeName: "usage",
      description: "Статистика использования и расходов.",
      textAlias: "/usage",
      category: "options",
      args: [
        {
    ...
    defineChatCommand({
      key: "stop",
      nativeName: "stop",
      description: "Остановить текущий запрос.",
      textAlias: "/stop",
      category: "session",
    }),
    defineChatCommand({
    ...
    defineChatCommand({
      ...
      description: "Режим активации в группах.",
    ...
    defineChatCommand({
      key: "compact",
      nativeName: "compact",
      description: "Сжать контекст сессии.",
      textAlias: "/compact",
      category: "session",
      args: [
        {
    ...
    defineChatCommand({
      key: "think",
      nativeName: "think",
      description: "Уровень размышлений.",
      textAlias: "/think",
      category: "options",
      args: [
        {
    ...
    defineChatCommand({
      key: "elevated",
      nativeName: "elevated",
      description: "Расширенный режим доступа.",
      textAlias: "/elevated",
      category: "options",
      args: [
        {
    ...
    defineChatCommand({
      key: "model",
      nativeName: "model",
      description: "Показать или сменить модель.",
      textAlias: "/model",
      category: "options",
      args: [
        {
    ...
    defineChatCommand({
      key: "models",
      nativeName: "models",
      description: "Список моделей и провайдеров.",
      textAlias: "/models",
      argsParsing: "none",
      acceptsArgs: true,
      category: "options",
    ...
    defineChatCommand({
      key: "queue",
      nativeName: "queue",
      description: "Настройки очереди сообщений.",
      textAlias: "/queue",
      category: "options",
      args: [
        {
